...
; What does this do?
; Prints the number to the screen if the method of addressing the memory is correct. 
; If it is wrong more than just the # references will appear. ie. attempt 3 will print 3X
; Attempt 2 will print solely 2
; Attemp 4 will print solely 4 but that is not the perferred method of doing the operation..